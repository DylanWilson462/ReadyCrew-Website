...
export default function ProblemSection() {
  ...
  return (
    <section ref={ref} className="w-full bg-[#F9FAFB] py-16 sm:py-20 md:py-28 px-4 sm:px-6">
      <div className="w-full max-w-6xl mx-auto">
        ...
        <motion.h2
          ...
          className="text-3xl sm:text-4xl md:text-5xl text-[#111827] mb-6 leading-tight text-center md:text-left"
        ...
        <motion.p
          ...
          className="text-base md:text-lg text-[#6B7280] max-w-2xl mb-12 sm:mb-16 leading-relaxed text-center md:text-left mx-auto md:mx-0"
        >
